...
<script src="${pageContext.request.contextPath }/js/userlogin.js?date=<%=new Date()%>"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/dom.js"></script>
<script>
	function changeimg() {
		var img = document.getElementById("checkimg");
		img.src = "${pageContext.request.contextPath}/checkImg.action?"
				+ new Date().getTime();
	}
	//验证表单
	function checkForm(){
		if($("#username").val() == null || $("#username").val() == ""){
			$("#pusername").text("用户名不能为空!");
			return false;
		}
			...
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" method="post" novalidate="novalidate"
						action="${pageContext.request.contextPath }/regist.action" onsubmit="return checkForm();">
						<table>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											maxlength="4" autocomplete="off"><img id="checkimg"
												...
												title="点击更换验证码" onclick="changeimg()"></span>
						...
						<div class="login">
							...
							<dl>
								<dt>已经拥有账号了？</dt>
								<dd>
									立即登录即可体验在线购物！ <a href="${pageContext.request.contextPath }/toLoginPage.action">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
