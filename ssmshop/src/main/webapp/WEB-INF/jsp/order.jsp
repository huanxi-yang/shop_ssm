...
<script type="text/javascript">
	function changeColor(){
		...
		color=color.split("|");
		document.getElementById("blingbling").style.color=color[parseInt(Math.random() * color.length)]; 
	}
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					...
					<c:forEach var="orderItems" items="${requestScope.order.orderItems }">
						<tr>
							<td width="60">
			...
			<form id="orderForm" action="${pageContext.request.contextPath }/payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="${sessionScope.user.addr }" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${sessionScope.user.name }" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text"value="${sessionScope.user.phone }" style="width:150px" />
			...
			<p style="text-align:right" >
							<a id="blingbling" href="${pageContext.request.contextPath }/toWeChatPay.action"><font size="5"><strong>推荐使用微信支付</strong></font></a>
						</p>
		</div>
