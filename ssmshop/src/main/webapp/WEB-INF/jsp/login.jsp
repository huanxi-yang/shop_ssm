		...
		<div class="topNav clearfix">
			<ul>
				...
				<li id="headerLogout" class="headerLogout">
					<a href="${pageContext.request.contextPath }/toIndex.action">[退出]</a>|
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<form id="loginForm"  method="post" novalidate="novalidate" action="${pageContext.request.contextPath }/login.action">
						<table>
							<tbody><tr>
								<th>
										<strong>用户名</strong>:
							...
							<tr>
								...
								<td>
									...
									<label>
										&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/findPassWord.action">找回密码</a>
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr class="register">
								...
								<td>
									<dl>
										...
										<dd>
											立即注册即可体验在线购物！
											<a href="${pageContext.request.contextPath }/toRegistPage.action">立即注册</a>
										</dd>
									</dl>
								</td>
							</tr>
