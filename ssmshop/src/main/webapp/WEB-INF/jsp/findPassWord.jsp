...
<div class="ad">
		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					<div class="title">
						<strong>找回密码</strong>REFIND PASSWORD
					</div>
					<form id="loginForm"  method="post" novalidate="novalidate" action="">
						<table>
							<tbody><tr>
								<th>
										<strong>手机号(用于接受验证码)</strong>:
								</th>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" id="code" name="code" class="text" maxlength="20" autocomplete="off">
									<span id="pcode"></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="submit" class="submit" name="sub" id="sub" value="获取验证码" onclick="return lie();"/>
								</td>
							</tr>
							<tr class="register">
								<th>&nbsp;
